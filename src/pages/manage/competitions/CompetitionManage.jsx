      ...
      <div className="border-t border-slate-100 pt-3 mt-3">
        <div className="flex items-start gap-3">
          <div className="flex-1">
            ...
            <p className="text-[11px] text-slate-400">
              Awarded when a team forfeits or fails to fulfil a match — default
...
function FixturesTab({ competition, teams, fixtures, setFixtures }) {
  ...
  async function handleCreateFixture(e) {
    ...
    try {
      ...
      setShowNew(false)
      setNewForm({ homeTeamId: '', awayTeamId: '', scheduledAt: '', pitch: '', venueId: null, venueSlug: null, periods: defaultFmt.periods, periodMinutes: defaultFmt.periodMinutes, breakMinutes: defaultFmt.breakMinutes, sevens: defaultFmt.sevens })
    } finally { setSaving(false) }
  }
