    ...
    >
      {showAdd && (
        <form onSubmit={handleCreate} className="px-4 py-4 border-b border-slate-200 space-y-4">
          ...
          <div>
            <label className="text-[10px] font-bold uppercase tracking-widest text-slate-400 block mb-1.5">
              Venue / pitch <span className="normal-case tracking-normal font-normal text-slate-400">(optional)</span>
            </label>
            <VenuePicker
  ...
  async function handleCreate(e) {
    ...
    try {
      ...
      setTeams(prev => [...prev, {
        ...
        active: true, primaryColor: org.primaryColor ?? null,
...
export default function OrgManage() {
  ...
  const { uid, isPlatformAdmin, isOrgMember, orgRoles, canDo, userEntitlement } = useAuth()
