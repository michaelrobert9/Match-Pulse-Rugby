...
// points (already included in Pts, broken out for transparency) appear as an
// extra BP column when bonus scoring is in play — see showBonus below.
const BASE_COLS = ['P', 'W', 'D', 'L', 'PF', 'PA', 'PD', 'TF']
