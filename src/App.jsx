  ...
  return (
    <AuthProvider>
      ...
      <Routes>
        ...
        {/* Auth — sign-in/up happen LOCALLY on this origin. The /login and
            /signup routes must stay OUTSIDE the auth guard and the shell. */}
        ...
        <Route element={<AppShell />}>
          ...
          <Route path="/manage/competitions/:id/teams/:teamId/sheet" element={<ProtectedRoute require="any"><TeamSheetPage /></ProtectedRoute>} />
